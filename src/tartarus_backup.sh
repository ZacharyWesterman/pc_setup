...
echo "Pulling other backups..."
rsync -a daedalus:/var/lib/jellyfin/data/backups /mnt/storage/daedalus-jellyfin/ "$@"
...
rsync -a daedalus:/etc/apache2/sites-enabled/skrunk.conf /mnt/storage/dedalus-conf/ "$@"
